                ...
                <div class="{{ $col_val }}" style="background-color: {{ get_setting('todays_deal_bg_color', '#3d4666') }}">
                    ...
                    <div class="c-scrollbar-light overflow-hidden px-4 px-md-5 pb-3 pt-3 pt-md-3 pb-md-5">
                        <div class="h-100 d-flex flex-column justify-content-center">
                            <div class="todays-deal pex-carousel" data-items="{{ $xxl_items }}" data-xxl-items="{{ $xxl_items }}" data-xl-items="{{ $xxl_items }}" data-lg-items="5" data-md-items="4" data-sm-items="3" data-xs-items="2" data-arrows="true" data-dots="false" data-autoplay="true" data-infinite="true">
