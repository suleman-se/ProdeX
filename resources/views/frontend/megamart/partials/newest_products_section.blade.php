@if (count($newest_products) > 0)
    ...
    <section class="border">
        <div class="px-3">
            ...
            <!-- Products Section -->
            <div class="px-sm-3">
                <div class="pex-carousel arrow-none sm-gutters-16" data-rows="2" data-items="{{ $xxl_items }}" data-xl-items="{{ $xxl_items }}" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
