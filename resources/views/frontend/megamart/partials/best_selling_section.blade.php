...
@if (get_setting('best_selling') == 1 && count($best_selling_products) > 0)
    <section class="border">
        <div class="px-3">
            ...
            <!-- Product Section -->
            <div class="px-sm-3">
                <div class="pex-carousel sm-gutters-16 arrow-none" data-rows="2" data-items="{{ $xxl_items }}" data-xl-items="{{ $xl_items }}" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
