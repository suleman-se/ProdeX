<div class="pex-user-sidenav-wrap position-relative z-1 rounded-0">
    <div class="pex-user-sidenav overflow-auto c-scrollbar-light px-4 pb-4">
        <!-- Close button -->
        <div class="d-xl-none">
            <button class="btn btn-sm p-2 " data-toggle="class-toggle" data-backdrop="static"
                data-target=".pex-mobile-side-nav" data-same=".mobile-side-nav-thumb">
        ...
        <!-- Menus -->
        <div class="sidemnenu">
            <ul class="pex-side-nav-list mb-3 pb-3 border-bottom" data-toggle="pex-side-menu">

                <!-- Dashboard -->
                <li class="pex-side-nav-item">
                    <a href="{{ route('dashboard') }}" class="pex-side-nav-link {{ areActiveRoutes(['dashboard']) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            <g id="Group_24768" data-name="Group 24768" transform="translate(3495.144 -602)">
                              <path id="Path_2916" data-name="Path 2916" d="M15.3,5.4,9.561.481A2,2,0,0,0,8.26,0H7.74a2,2,0,0,0-1.3.481L.7,5.4A2,2,0,0,0,0,6.92V14a2,2,0,0,0,2,2H14a2,2,0,0,0,2-2V6.92A2,2,0,0,0,15.3,5.4M10,15H6V9A1,1,0,0,1,7,8H9a1,1,0,0,1,1,1Zm5-1a1,1,0,0,1-1,1H11V9A2,2,0,0,0,9,7H7A2,2,0,0,0,5,9v6H2a1,1,0,0,1-1-1V6.92a1,1,0,0,1,.349-.76l5.74-4.92A1,1,0,0,1,7.74,1h.52a1,1,0,0,1,.651.24l5.74,4.92A1,1,0,0,1,15,6.92Z" transform="translate(-3495.144 602)" fill="#b5b5bf"/>
                            </g>
                        </svg>
                        <span class="pex-side-nav-text ml-3">{{ translate('Dashboard') }}</span>
                    </a>
                </li>
                ...
                <li class="pex-side-nav-item">
                    <a href="{{ route('purchase_history.index') }}"
                        class="pex-side-nav-link {{ areActiveRoutes(['purchase_history.index', 'purchase_history.details']) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="pex-side-nav-text ml-3">{{ translate('Purchase History') }}</span>
                ...
                @if (addon_is_activated('preorder'))
                    <li class="pex-side-nav-item">
                        <a href="javascript:void(0);" class="pex-side-nav-link">
                            ...
                            <span class="pex-side-nav-text ml-3">{{ translate('Preorder') }}</span>
                            <span class="pex-side-nav-arrow"></span>
                        </a>
                        <ul class="pex-side-nav-list level-2">
                            <li class="pex-side-nav-item">
                                <a href="{{ route('preorder.order_list') }}" class="pex-side-nav-link {{ areActiveRoutes(['preorder.order_list']) }}">
                                    <span class="pex-side-nav-text">{{ translate('Preorder List') }}</span>
                                </a>
                            </li>
                            @if (get_setting('conversation_system') == 1) 
                                ...
                                <li class="pex-side-nav-item">
                                    <a href="{{ route('preorder-conversations.customer-index') }}"
                                        class="pex-side-nav-link {{ areActiveRoutes(['preorder-conversations.customer-show']) }}">
                                        <span class="pex-side-nav-text">{{ translate('Preorder Conversations') }}</span>
                ...
                <li class="pex-side-nav-item">
                    <a href="{{ route('digital_purchase_history.index') }}"
                        class="pex-side-nav-link {{ areActiveRoutes(['digital_purchase_history.index']) }}">
                        ...
                        <span class="pex-side-nav-text ml-3">{{ translate('Downloads') }}</span>
                    </a>
                </li>
                ...
                @if (addon_is_activated('refund_request'))
                    <li class="pex-side-nav-item">
                        <a href="{{ route('customer_refund_request') }}"
                            class="pex-side-nav-link {{ areActiveRoutes(['customer_refund_request']) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            ...
                            <span class="pex-side-nav-text ml-3">{{ translate('Refund Requests') }}</span>
                        </a>
                    </li>
                @endif
                ...
                <li class="pex-side-nav-item">
                    <a href="{{ route('wishlists.index') }}"
                        class="pex-side-nav-link {{ areActiveRoutes(['wishlists.index']) }}">
                        ...
                        <span class="pex-side-nav-text ml-3">{{ translate('Wishlist') }}</span>
                    </a>
                </li>

                <!-- Compare -->
                <li class="pex-side-nav-item">
                    <a href="{{ route('compare') }}" class="pex-side-nav-link {{ areActiveRoutes(['compare']) }}">
                        ...
                        <span class="pex-side-nav-text ml-3">{{ translate('Compare') }}</span>
                    </a>
                </li>
                ...
                <!-- Followed Sellers -->
                <li class="pex-side-nav-item">
                    <a href="{{ route('followed_seller') }}" class="pex-side-nav-link {{ areActiveRoutes(['followed_seller']) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="pex-side-nav-text ml-3">{{ translate('Followed Sellers') }}</span>
                    </a>
                </li>
                @endif
                ...
                @if (get_setting('classified_product') == 1)
                    <li class="pex-side-nav-item">
                        <a href="{{ route('customer_products.index') }}"
                            class="pex-side-nav-link {{ areActiveRoutes(['customer_products.index', 'customer_products.create', 'customer_products.edit']) }}">
                            ...
                            <span class="pex-side-nav-text ml-3">{{ translate('Classified Products') }}</span>
                        </a>
                    </li>
                @endif
                ...
                @if (addon_is_activated('auction'))
                    <li class="pex-side-nav-item">
                        <a href="javascript:void(0);" class="pex-side-nav-link">
                            ...
                            <span class="pex-side-nav-text ml-3">{{ translate('Auction') }}</span>
                            <span class="pex-side-nav-arrow"></span>
                        </a>
                        <ul class="pex-side-nav-list level-2">
                            <li class="pex-side-nav-item">
                                <a href="{{ route('auction_product_bids.index') }}" class="pex-side-nav-link">
                                    <span class="pex-side-nav-text">{{ translate('Bidded Products') }}</span>
                                </a>
                            </li>
                            <li class="pex-side-nav-item">
                                <a href="{{ route('auction_product.purchase_history') }}"
                                    class="pex-side-nav-link">
                                    <span class="pex-side-nav-text">{{ translate('Purchase History') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                @if (get_setting('conversation_system') == 1)
                    ...
                    <li class="pex-side-nav-item">
                        <a href="{{ route('conversations.index') }}"
                            class="pex-side-nav-link {{ areActiveRoutes(['conversations.index', 'conversations.show']) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            ...
                            <span class="pex-side-nav-text ml-3">{{ translate('Conversations') }}</span>
                ...
                @if (get_setting('wallet_system') == 1)
                    <li class="pex-side-nav-item">
                        <a href="{{ route('wallet.index') }}"
                            class="pex-side-nav-link {{ areActiveRoutes(['wallet.index']) }}">
                            ...
                            <span class="pex-side-nav-text ml-3">{{ translate('My Wallet') }}</span>
                        </a>
                    </li>
                @endif
                ...
                @if (addon_is_activated('club_point'))
                    <li class="pex-side-nav-item">
                        <a href="{{ route('earnng_point_for_user') }}"
                            class="pex-side-nav-link {{ areActiveRoutes(['earnng_point_for_user']) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            ...
                            <span class="pex-side-nav-text ml-3">{{ translate('Earning Points') }}</span>
                        </a>
                    </li>
                @endif
                ...
                @if (addon_is_activated('affiliate_system') &&
                    ...
                    <li class="pex-side-nav-item">
                        <a href="javascript:void(0);"
                            ...
                            <span class="pex-side-nav-text ml-3">{{ translate('Affiliate') }}</span>
                            <span class="pex-side-nav-arrow"></span>
                        </a>
                        <ul class="pex-side-nav-list level-2">
                            <li class="pex-side-nav-item">
                                <a href="{{ route('affiliate.user.index') }}" class="pex-side-nav-link {{ areActiveRoutes(['affiliate.user.index','affiliate.payment_settings']) }}">
                            ...
                            <li class="pex-side-nav-item">
                                <a href="{{ route('affiliate.user.withdraw_request_history') }}"
                                    class="pex-side-nav-link">
                                    <span
                                        class="pex-side-nav-text">{{ translate('Withdraw request history') }}</span>
                                </a>
                            </li>
                ...
                <li class="pex-side-nav-item">
                    <a href="{{ route('support_ticket.index') }}"
                        class="pex-side-nav-link {{ areActiveRoutes(['support_ticket.index', 'support_ticket.show']) }}">
                        ...
                        <span class="pex-side-nav-text ml-3">{{ translate('Support Ticket') }}</span>
                        @if ($support_ticket > 0)
                ...
                <!-- Manage Profile -->
                <li class="pex-side-nav-item">
                    <a href="{{ route('profile') }}" class="pex-side-nav-link {{ areActiveRoutes(['profile']) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="pex-side-nav-text ml-3">{{ translate('Manage Profile') }}</span>
                    </a>
                </li>

                <!-- Delete My Account -->
                <li class="pex-side-nav-item">
                    <a href="javascript:void(0)" onclick="account_delete_confirm_modal('{{ route('account_delete') }}')" class="pex-side-nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="pex-side-nav-text ml-3">{{ translate('Delete My Account') }}</span>
                    </a>
                </li>
