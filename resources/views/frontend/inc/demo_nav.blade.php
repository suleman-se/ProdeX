<!-- Demo nav -->
<div class="pex-demo-nav">
    <!-- Mobile bottom nav toggler-->
    <div class="bg-white position-relative">
        <a href="javascript:void(0);" class="position-relative pex-demo-nav-item pex-demo-nav-toggler">
            <div class="pex-demo-nav-btn">
    ...
    <!-- Mobile bottom nav toggler-->
    <div class="pex-demo-nav-links">
        <a href="https://activeitzone.com/docs/active-ecommerce-cms/" class="pex-demo-nav-item" target="_blank">
        ...
        <a href="https://www.youtube.com/watch?v=FFjausSYe3M" class="pex-demo-nav-item" target="_blank">
        ...
        <a href="https://www.youtube.com/watch?v=zW6FwRsaxDk" class="pex-demo-nav-item" target="_blank">
        ...
        <div class="px-2rem">
            <div class="row gutters-16">
                ...
                <div class="col-md-6 my-3">
                    ...
                    <p class="demo-title">{{ translate('ProdeX Main Demo') }}</p>
                </div>
                <!-- Grocery Store -->
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
