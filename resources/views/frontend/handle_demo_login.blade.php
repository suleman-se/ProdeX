                ...
                <div class="demo-admin-links w-100 py-5 my-lg-5 px-4 mx-auto">
                    <div class="row overflow-hidden rounded-3" style="border: 1px solid #f2f2f2;">
                        <div class="col-md-6 px-0 d-none d-md-block"  style="border-right: 1px solid #f2f2f2;">
                            <img class="img-fit h-100" src="{{ my_asset('assets/img/demo/link/link.png') }}" alt="ProdeX">
                        </div>
                        <div class="col-md-6 px-2rem py-5 d-flex flex-column justify-content-center">
                            <div class="mb-4 text-center">
                                <img class="h-40px" src="{{ my_asset('assets/img/demo/link/logo.svg') }}" alt="ProdeX">
                            </div>
                            <a href="{{ route('user.login') }}" class="btn btn-block btn-lg btn-soft-primary fs-14 fw-700 mb-3 rounded-2">Login as Customer</a>
                            <a href="{{ route('login') }}" class="btn btn-block btn-lg btn-soft-info fs-14 fw-700 mb-3 rounded-2">Login as Admin</a>
                            <a href="{{ route('seller.login') }}" class="btn btn-block btn-lg btn-soft-success fs-14 fw-700 mb-3 rounded-2">Login as Supplier</a>
                            ...
                            <small class="d-block fs-10 text-center" style="color: #78829d;">* Click the links above to login to your ProdeX platform.</small>
                        </div>
                    </div>
                    <div class="text-center" style="margin-top: 40px;">
                        ...
                        <div class="">
                            <a href="https://prodex.pk/" target="_blank" class="fs-12 hov-text-primary" style="color: #78829d;">www.prodex.pk</a>
                        </div>
                    </div>
                </div>
            </div>
