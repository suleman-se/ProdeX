            ...
            <div class="container">
                <div class="demo-admin-links w-100 py-5 my-lg-5 px-4 mx-auto">
                    ...
                    <div class="text-center" style="margin-top: 40px;">
                        <small class="d-block fs-12 text-center mb-3" style="color: #78829d;">Mobile Apps for ProdeX</small>
                        ...
                        <div class="mb-5">
                            <a href="https://codecanyon.net/user/activeitzone/portfolio" target="_blank" class="fs-12 fw-500 hov-text-primary" style="text-decoration: underline; text-transform: uppercase;color: #78829d;">View all Add-ons for ProdeX</a>
                        </div>
