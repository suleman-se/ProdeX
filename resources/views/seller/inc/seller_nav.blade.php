<div class="pex-topbar px-15px px-lg-25px d-flex align-items-stretch justify-content-between">
    <div class="d-flex">
        <div class="pex-topbar-nav-toggler d-flex align-items-center justify-content-start mr-2 mr-md-3 ml-0" data-toggle="pex-mobile-nav">
            <button class="pex-mobile-toggler">
                <span></span>
            </button>
        </div>
    </div>
    <div class="d-flex justify-content-between align-items-stretch flex-grow-xl-1">
        ...
        <div class="d-flex justify-content-around align-items-center align-items-stretch">
            ...
            @endphp
            <div class="pex-topbar-item ml-2">
