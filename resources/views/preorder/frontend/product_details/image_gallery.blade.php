<div class="z-3 row gutters-10">
    ...
    @endphp
        ...
        <div class="col-2 d-none d-lg-block m-0 p-0">
            <div class="pex-carousel half-outside-arrow product-gallery-thumb m-0 p-0" data-items='4' data-nav-for='.product-gallery'
    ...
    <!-- Gallery Images -->
    <div class="col-10">
        <div class="pex-carousel product-gallery arrow-inactive-transparent arrow-lg-none m-0 p-0"
